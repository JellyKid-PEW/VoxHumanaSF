...
export const SEED_CONSTRAINTS = [
  ...
  // ======== medbay ========
  {
    ...
    claims: [
      ...
      { kind: 'presence', target: 'medUpperBed' },
    ],
  },
  {
    ...
    interpretation: '"The cot" (always singular in Presence and Book 3) is the lower, real recovery bed — the fold-down above it stays latched and unmentioned. It holds a patient at a set angle.',
    evidence: 'explicit',
